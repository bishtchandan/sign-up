...
function validation() {
    if (fname.value == "" && ename.value=="" && pname.value=="") {
        error.innerHTML = "Username, email and password must be filled";
    ...
    else if (ename.value == ""&& pname.value=="") {
        error.innerHTML = "email and password must be filled";
        error.style.display = "block";
        return false;
    }
    else if (ename.value == "") {
